import contextlib
import os
import pathlib  # Fantastic python module for path
import tempfile
...
def mock_b2_upload_file(mocker):
    return mocker.patch(
        "socialmedia_api.routers.upload.b2_upload_file",
...
async def test_temp_file_removed_after_upload(
    ...
    created_temp_file = (
        named_temp_file_spy.spy_return
    )  # it asserts that the function was called
